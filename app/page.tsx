...
export default async function DashboardPage() {
  ...
  return (
    <div className="max-w-4xl space-y-8 py-2">
      ...
      {/* Recent activity */}
      <div className="animate-fade-up delay-5 rounded-xl border border-border overflow-hidden" style={{ background: '#101220' }}>
          ...
          <div>
            {stats.recent.map((app, i) => (
              <div
                ...
                style={{ borderBottom: i < stats.recent.length - 1 ? '1px solid #1a1d32' : 'none' }}
              >
